...
[(set (match_operand:DI          0 "register_operand" "=r")
(mem:DI (plus:SI (match_operand:SI 1 "register_operand" " r")
...
[(set (mem:DI (plus:SI (match_operand:SI 0 "register_operand" "=r")
