		      ...
		      struct gcc_options *opts_set)
{
  ...
  if (opts_set->x_param_fsm_maximum_phi_arguments) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_param_fsm_scale_path_blocks) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_param_fsm_scale_path_stmts) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_param_gcse_after_reload_critical_fraction) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_param_gcse_after_reload_partial_fraction) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_param_gcse_cost_distance_ratio) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_param_gcse_unrestricted_cost) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_param_graphite_max_arrays_per_scop) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_param_graphite_max_nb_scop_params) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_param_hwasan_instrument_allocas) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_param_hwasan_instrument_mem_intrinsics) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_param_hwasan_instrument_reads) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_param_hwasan_instrument_stack) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_param_hwasan_instrument_writes) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_param_hwasan_random_frame_tag) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_param_inline_heuristics_hint_percent) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_param_inline_min_speedup) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_param_inline_unit_growth) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_param_ipa_cp_eval_threshold) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_param_ipa_cp_large_unit_insns) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_param_ipa_cp_loop_hint_bonus) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_param_ipa_cp_max_recursive_depth) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_param_ipa_cp_min_recursive_probability) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_param_ipa_cp_recursion_penalty) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_param_ipa_cp_single_call_penalty) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_param_ipa_cp_unit_growth) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_param_ipa_cp_value_list_size) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_param_ipa_jump_function_lookups) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_param_ipa_max_aa_steps) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_param_ipa_max_agg_items) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_param_ipa_max_loop_predicates) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_param_ipa_max_param_expr_ops) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_param_ipa_max_switch_predicate_bounds) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_param_ipa_sra_max_replacements) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_param_ipa_sra_ptr_growth_factor) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_param_ira_loop_reserved_regs) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_param_ira_max_conflict_table_size) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_param_ira_max_loops_num) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_param_iv_always_prune_cand_set_bound) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_param_iv_consider_all_candidates_bound) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_param_iv_max_considered_uses) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_param_jump_table_max_growth_ratio_for_size) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_param_jump_table_max_growth_ratio_for_speed) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_param_l1_cache_line_size) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_param_l1_cache_size) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_param_l2_cache_size) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[0] = mask;
  mask = 0;
  if (opts_set->x_param_large_function_growth) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_param_large_function_insns) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_param_stack_frame_growth) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_param_large_stack_frame) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_param_large_unit_insns) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_param_lim_expensive) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_param_loop_block_tile_size) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_param_loop_interchange_max_num_stmts) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_param_loop_interchange_stride_ratio) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_param_loop_invariant_max_bbs_in_loop) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_param_loop_max_datarefs_for_datadeps) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_param_loop_versioning_max_inner_insns) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_param_loop_versioning_max_outer_insns) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_param_lra_inheritance_ebb_probability_cutoff) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_param_lra_max_considered_reload_pseudos) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_param_max_average_unrolled_insns) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_param_max_combine_insns) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_param_max_unroll_iterations) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_param_max_completely_peel_times) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_param_max_completely_peeled_insns) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_param_max_crossjump_edges) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_param_max_cse_insns) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_param_max_cse_path_length) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_param_max_cselib_memory_locations) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_param_max_debug_marker_count) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_param_max_delay_slot_insn_search) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_param_max_delay_slot_live_search) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_param_max_dse_active_local_stores) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_param_early_inliner_max_iterations) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_param_max_find_base_term_values) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_param_max_fsm_thread_length) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_param_max_fsm_thread_path_insns) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_param_max_fsm_thread_paths) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_param_max_gcse_insertion_ratio) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_param_max_gcse_memory) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_param_max_goto_duplication_insns) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_param_max_grow_copy_bb_insns) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_param_max_hoist_depth) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_param_max_inline_insns_auto) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_param_max_inline_insns_recursive_auto) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_param_max_inline_insns_recursive) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_param_max_inline_insns_single) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_param_max_inline_insns_size) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_param_max_inline_insns_small) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_param_max_inline_recursive_depth_auto) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_param_max_inline_recursive_depth) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_param_max_isl_operations) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_param_max_iterations_computation_cost) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_param_max_iterations_to_track) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_param_max_jump_thread_duplication_stmts) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_param_max_last_value_rtl) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_param_max_loop_header_insns) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_param_max_modulo_backtrack_attempts) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_param_max_partial_antic_length) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_param_max_peel_branches) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_param_max_peel_times) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_param_max_peeled_insns) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_param_max_pending_list_length) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_param_max_pipeline_region_blocks) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_param_max_pipeline_region_insns) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_param_max_pow_sqrt_depth) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_param_max_predicted_iterations) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_param_max_reload_search_insns) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_param_max_rtl_if_conversion_insns) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[1] = mask;
  mask = 0;
  if (opts_set->x_param_max_rtl_if_conversion_predictable_cost) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_param_max_rtl_if_conversion_unpredictable_cost) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_param_max_sched_extend_regions_iters) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_param_max_sched_insn_conflict_delay) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_param_max_sched_ready_insns) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_param_max_sched_region_blocks) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_param_max_sched_region_insns) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_param_max_slsr_candidate_scan) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_param_max_speculative_devirt_maydefs) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_param_max_stores_to_merge) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_param_max_stores_to_sink) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_param_max_tail_merge_comparisons) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_param_max_tail_merge_iterations) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_param_max_tracked_strlens) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_param_max_tree_if_conversion_phi_args) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_param_max_unroll_times) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_param_max_unrolled_insns) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_param_max_unswitch_insns) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_param_max_unswitch_level) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_param_max_variable_expansions) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_param_max_vartrack_expr_depth) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_param_max_vartrack_reverse_op_size) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_param_max_vartrack_size) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_param_max_vrp_switch_assertions) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_param_min_crossjump_insns) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_param_min_inline_recursive_probability) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_param_min_insn_to_prefetch_ratio) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_param_min_loop_cond_split_prob) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_param_min_size_for_stack_sharing) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_param_min_spec_prob) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_param_min_vect_loop_bound) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_param_modref_max_accesses) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_param_modref_max_bases) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_param_modref_max_depth) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_param_modref_max_escape_points) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_param_modref_max_refs) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_param_modref_max_tests) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_param_parloops_chunk_size) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_param_parloops_min_per_thread) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_param_parloops_schedule) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_param_partial_inlining_entry_probability) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_param_predictable_branch_outcome) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_param_prefetch_dynamic_strides) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_param_prefetch_latency) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_param_prefetch_min_insn_to_mem_ratio) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_param_prefetch_minimum_stride) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_param_ranger_logical_depth) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_param_rpo_vn_max_loop_depth) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_param_sccvn_max_alias_queries_per_access) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_param_scev_max_expr_complexity) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_param_scev_max_expr_size) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_param_sched_autopref_queue_depth) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_param_sched_mem_true_dep_cost) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_param_sched_pressure_algorithm) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_param_sched_spec_prob_cutoff) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_param_sched_state_edge_prob_cutoff) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_param_selsched_insns_to_rename) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_param_selsched_max_lookahead) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_param_selsched_max_sched_times) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_param_simultaneous_prefetches) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_param_sink_frequency_threshold) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_param_sms_dfa_history) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_param_sms_loop_average_count_threshold) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_param_sms_max_ii_factor) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[2] = mask;
  mask = 0;
  if (opts_set->x_param_sms_min_sc) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_param_sra_max_propagations) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_param_sra_max_scalarization_size_size) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_param_sra_max_scalarization_size_speed) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_param_ssa_name_def_chain_limit) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_param_ssp_buffer_size) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_param_stack_clash_protection_guard_size) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_param_stack_clash_protection_probe_interval) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_param_store_merging_allow_unaligned) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_param_store_merging_max_size) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_param_switch_conversion_branch_ratio) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_param_tm_max_aggregate_size) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_param_tracer_dynamic_coverage_feedback) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_param_tracer_dynamic_coverage) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_param_tracer_max_code_growth) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_param_tracer_min_branch_probability_feedback) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_param_tracer_min_branch_probability) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_param_tracer_min_branch_ratio) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_param_tree_reassoc_width) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_param_uninit_control_dep_attempts) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_param_uninlined_function_insns) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_param_uninlined_function_time) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_param_uninlined_function_thunk_insns) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_param_uninlined_function_thunk_time) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_param_unlikely_bb_count_fraction) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_param_unroll_jam_max_unroll) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_param_unroll_jam_min_percent) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_param_use_after_scope_direct_emission_threshold) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_param_vect_epilogues_nomask) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_param_vect_max_peeling_for_alignment) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_param_vect_max_version_for_alias_checks) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_param_vect_max_version_for_alignment_checks) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_param_vect_partial_vector_usage) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_sched_stalled_insns) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_sched_stalled_insns_dep) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_tree_parallelize_loops) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_param_evrp_mode) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_excess_precision) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_fp_contract_mode) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_ira_algorithm) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_ira_region) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_live_patching) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_reorder_blocks_algorithm) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_simd_cost_model) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_stack_reuse) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_vect_cost_model) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_optimize) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_optimize_size) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_optimize_debug) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_optimize_fast) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_warn_inline) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_aggressive_loop_optimizations) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_align_functions) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_align_jumps) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_align_labels) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_align_loops) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_allocation_dce) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_store_data_races) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_associative_math) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_assume_phsa) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_asynchronous_unwind_tables) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_auto_inc_dec) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_bit_tests) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_branch_on_count_reg) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[3] = mask;
  mask = 0;
  if (opts_set->x_flag_branch_probabilities) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_caller_saves) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_code_hoisting) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_combine_stack_adjustments) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_compare_elim_after_reload) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_conserve_stack) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_cprop_registers) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_crossjumping) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_cse_follow_jumps) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_cx_fortran_rules) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_cx_limited_range) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_dce) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_defer_pop) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_delayed_branch) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_delete_dead_exceptions) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_delete_null_pointer_checks) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_devirtualize) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_devirtualize_speculatively) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_dse) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_early_inlining) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_exceptions) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_expensive_optimizations) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_finite_loops) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_finite_math_only) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_float_store) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_forward_propagate) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_fp_int_builtin_inexact) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_no_function_cse) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_gcse) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_gcse_after_reload) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_gcse_las) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_gcse_lm) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_gcse_sm) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_graphite) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_graphite_identity) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_guess_branch_prob) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_hoist_adjacent_loads) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_if_conversion) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_if_conversion2) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_indirect_inlining) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_no_inline) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_inline_atomics) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_inline_functions) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_inline_functions_called_once) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_inline_small_functions) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_ipa_bit_cp) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_ipa_cp) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_ipa_cp_clone) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_ipa_icf) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_ipa_icf_functions) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_ipa_icf_variables) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_ipa_modref) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_ipa_profile) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_ipa_pta) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_ipa_pure_const) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_ipa_ra) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_ipa_reference) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_ipa_reference_addressable) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_ipa_sra) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_ipa_stack_alignment) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_ipa_vrp) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_ira_hoist_pressure) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_ira_loop_pressure) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_ira_share_save_slots) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[4] = mask;
  mask = 0;
  if (opts_set->x_flag_ira_share_spill_slots) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_isolate_erroneous_paths_attribute) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_isolate_erroneous_paths_dereference) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_ivopts) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_jump_tables) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_keep_gc_roots_live) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_lifetime_dse) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_limit_function_alignment) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_live_range_shrinkage) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_loop_interchange) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_loop_nest_optimize) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_loop_parallelize_all) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_unroll_jam) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_lra_remat) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_errno_math) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_modulo_sched) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_modulo_sched_allow_regmoves) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_move_loop_invariants) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_non_call_exceptions) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_nothrow_opt) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_omit_frame_pointer) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_opt_info) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_optimize_sibling_calls) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_optimize_strlen) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_pack_struct) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_partial_inlining) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_peel_loops) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_no_peephole) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_peephole2) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_plt) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_predictive_commoning) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_prefetch_loop_arrays) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_printf_return_value) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_profile_partial_training) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_profile_reorder_functions) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_reciprocal_math) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_ree) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_pcc_struct_return) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_rename_registers) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_reorder_blocks) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_reorder_blocks_and_partition) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_reorder_functions) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_rerun_cse_after_loop) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_resched_modulo_sched) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_rounding_math) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_rtti) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_save_optimization_record) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_sched_critical_path_heuristic) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_sched_dep_count_heuristic) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_sched_group_heuristic) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_schedule_interblock) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_sched_last_insn_heuristic) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_sched_pressure) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_sched_rank_heuristic) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_schedule_speculative) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_sched_spec_insn_heuristic) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_schedule_speculative_load) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_schedule_speculative_load_dangerous) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_sched2_use_superblocks) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_schedule_fusion) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_schedule_insns) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_schedule_insns_after_reload) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_section_anchors) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_sel_sched_pipelining) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[5] = mask;
  mask = 0;
  if (opts_set->x_flag_sel_sched_pipelining_outer_loops) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_sel_sched_reschedule_pipelined) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_selective_scheduling) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_selective_scheduling2) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_short_enums) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_short_wchar) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_shrink_wrap) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_shrink_wrap_separate) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_signaling_nans) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_signed_zeros) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_single_precision_constant) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_split_ivs_in_unroller) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_split_loops) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_split_paths) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_split_wide_types) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_split_wide_types_early) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_ssa_backprop) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_ssa_phiopt) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_stack_clash_protection) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_stack_protect) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_stdarg_opt) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_store_merging) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_strict_aliasing) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_strict_enums) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_strict_volatile_bitfields) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_thread_jumps) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_threadsafe_statics) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_toplevel_reorder) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_tracer) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_trapping_math) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_trapv) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_tree_bit_ccp) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_tree_builtin_call_dce) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_tree_ccp) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_tree_ch) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_tree_coalesce_vars) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_tree_copy_prop) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_tree_cselim) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_tree_dce) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_tree_dom) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_tree_dse) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_tree_forwprop) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_tree_fre) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_tree_loop_distribute_patterns) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_tree_loop_distribution) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_tree_loop_if_convert) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_tree_loop_im) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_tree_loop_ivcanon) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_tree_loop_optimize) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_tree_loop_vectorize) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_tree_live_range_split) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_tree_partial_pre) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_tree_phiprop) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_tree_pre) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_tree_pta) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_tree_reassoc) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_tree_scev_cprop) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_tree_sink) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_tree_slp_vectorize) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_tree_slsr) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_tree_sra) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_tree_switch_conversion) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_tree_tail_merge) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_tree_ter) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[6] = mask;
  mask = 0;
  if (opts_set->x_flag_tree_vrp) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_unconstrained_commons) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_unroll_all_loops) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_cunroll_grow_size) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_unroll_loops) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_unsafe_math_optimizations) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_unswitch_loops) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_unwind_tables) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_var_tracking) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_var_tracking_assignments) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_var_tracking_assignments_toggle) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_var_tracking_uninit) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_variable_expansion_in_unroller) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_version_loops_for_strides) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_value_profile_transformations) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_web) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_wrapv) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_wrapv_pointer) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_str_align_functions) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_str_align_jumps) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_str_align_labels) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_str_align_loops) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_patchable_function_entry) mask |= HOST_WIDE_INT_1U << 22;
		       ...
		       struct gcc_options *opts_set)
{
  ...
  ptr->x_riscv_crypto_subext = opts->x_riscv_crypto_subext;
  ptr->x_riscv_rvp_subext = opts->x_riscv_rvp_subext;
  ...
  unsigned HOST_WIDE_INT mask = 0;
  if (opts_set->x_riscv_crypto_subext) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_riscv_rvp_subext) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_riscv_stack_protector_guard_reg) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_riscv_zi_subext) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_riscv_stack_protector_guard_offset) mask |= HOST_WIDE_INT_1U << 4;
...
{
  opts->x_riscv_crypto_subext = ptr->x_riscv_crypto_subext;
  opts->x_riscv_rvp_subext = ptr->x_riscv_rvp_subext;
  ...
  unsigned HOST_WIDE_INT mask;
  mask = ptr->explicit_mask[0];
  opts_set->x_riscv_crypto_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_rvp_subext = (mask & 1) != 0;
  mask >>= 1;
...
{
  if (ptr1->x_riscv_crypto_subext != ptr2->x_riscv_crypto_subext)
    return false;
  if (ptr1->x_riscv_rvp_subext != ptr2->x_riscv_rvp_subext)
    return false;
...
{
  inchash::hash hstate;
  hstate.add_hwi (ptr->x_riscv_crypto_subext);
  hstate.add_hwi (ptr->x_riscv_rvp_subext);
...
{
  bp_pack_value (bp, ptr->x_riscv_crypto_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_rvp_subext, 64);
...
cl_target_option_stream_in (struct data_in *data_in ATTRIBUTE_UNUSED,
                            ...
                            struct cl_target_option *ptr ATTRIBUTE_UNUSED)
{
  ptr->x_riscv_crypto_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_rvp_subext = (int) bp_unpack_value (bp, 64);
